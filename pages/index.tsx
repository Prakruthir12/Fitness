  ...
  return (
    <div>
      ...
      <main className="font-bodyFont">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6 py-6" id="pages">
          {
            posts.map((post) => (
        ...
        <div className="flex space-x-5 bg-gray-100">
          <div className='max-w-3xl mx-auto py-16'>
            ...
            <div>
              ...
              {submitted ?(
                <div className="flex flex-col my-5 max-w-2xl mx-auto text-gray-400">
                ...
                <button 
                type= "submit"
                className= "w-full bg-purple-400 text-white text-base font-titleFont font-semibold tracking-wider uppercase py-2 rounded-sm hover:bg-secondaryColor duration-300">
                  Send
                </button>
